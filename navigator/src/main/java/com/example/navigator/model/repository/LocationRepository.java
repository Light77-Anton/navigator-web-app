...
public interface LocationRepository extends JpaRepository<Location, Long> {
    ...
    @Query(value = "UPDATE com.example.navigator.model.Location AS l SET l.latitude = :latitude, " +
            "l.longitude = :longitude, l.city = :city, l.country = :country WHERE l.id = :id")
    void updateLocation(double latitude, double longitude, String city, String country, long id);
